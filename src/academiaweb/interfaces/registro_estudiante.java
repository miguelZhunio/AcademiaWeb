...
import validaciones.Crear;
import validaciones.Registro;
...
public class registro_estudiante extends javax.swing.JFrame {
    ...
    private void setModelo() {
       String[] cabeceraTable = {"CEDULA", "NOMBRE", "APELLIDO", "PAIS", "CORREO" ,"FECHA"};
    ...
    private void setDatos() {
         ...
         Estudiante in;
         ObjectSet consultaEst = AcademiaWeb.Base.get(new Estudiante(null, null, null, null, null, null, null ,null));
         for (int j = 0; j < consultaEst.size(); j++) {
            in = (Estudiante) consultaEst.get(j);
            listadoEstudiantes.add(in);
            in = new Estudiante();
        }
         for (Estudiante aux: listadoEstudiantes) {
             datos[0] = aux.getCedula_per();
             datos[1] = aux.getNombre_per();
             datos[2] = aux.getApellido_per();
             datos[3] = aux.getCodigo_pais();
             datos[4] = aux.getCorreo_per();
             datos[5] = aux.getFecha_ins();
    ...
    private void initComponents() {
        ...
        Niveles.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Basico", "Intermedio", "Avanzado" }));

        jLabel12.setFont(new java.awt.Font("Segoe UI Black", 0, 12)); // NOI18N
        jLabel12.setText("Su nivel");

        Paises.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Ecuador", "Colombia ", "Peru", "Argentina", "EEUU", "Mexico" }));
        ...
        jPanel1Layout.setHorizontalGroup(
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                .addComponent(Niveles, javax.swing.GroupLayout.PREFERRED_SIZE, 119, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(141, 141, 141)))
                        .addGap(30, 30, 30)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
            ...
            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel1Layout.createSequentialGroup()
                    .addGap(241, 241, 241)
                    .addComponent(Paises, javax.swing.GroupLayout.PREFERRED_SIZE, 119, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String nivel = Niveles.getSelectedItem().toString();
        ...
        fechaString = Crear.Fecha(new Date());
        ...
        if (error) {
            ...
            AcademiaWeb.Base.set(new Estudiante(fechaString, nivel, Cedula, nombre, apellido, pais, correo, password));
            setDatos();
        }
